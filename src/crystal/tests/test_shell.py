...
from crystal.tests.util.cli import close_main_window, close_open_or_create_dialog, create_new_empty_project, delay_between_downloads_minimized, drain, _py_eval, _read_until, wait_for_crystal_to_exit, crystal_shell
