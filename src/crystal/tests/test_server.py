    ...
    with server:
        ...
        async with (await OpenOrCreateDialog.wait_for()).create() as (mw, project):
            ...
            with closing(ProjectServer(project)) as project_server:
                ...
                assert 'This page was archived using Crystal' in served_page.content
                ...
                def pw_task(raw_page: RawPage, *args, **kwargs) -> None:
                    ...
                    expect(footer_banner).to_contain_text(
                        'This page was archived using Crystal')
        ...
        async with (await OpenOrCreateDialog.wait_for()).create() as (mw, project):
            ...
            with closing(ProjectServer(project)) as project_server:
                ...
                def pw_task(raw_page: RawPage, *args, **kwargs) -> None:
                    ...
                    footer_banner = raw_page.locator('#cr-footer-banner')
                    expect(footer_banner).to_be_visible()
                    expect(footer_banner).to_contain_text('This page was archived using Crystal')
        ...
        async with (await OpenOrCreateDialog.wait_for()).create() as (mw, project):
            ...
            with closing(ProjectServer(project)) as project_server:
                ...
                def pw_task(raw_page: RawPage, *args, **kwargs) -> None:
                    ...
                    expect(main_banner).to_contain_text('This page was archived using Crystal')
            ...
            async with (await OpenOrCreateDialog.wait_for()).create() as (mw, project):
                ...
                with closing(ProjectServer(project)) as project_server:
                    ...
                    def pw_task(raw_page: RawPage, *args, **kwargs) -> None:
                        ...
                        expect(body_banner).to_contain_text('This page was archived using Crystal')
                    await pw.run(pw_task)
            ...
            async with (await OpenOrCreateDialog.wait_for()).create() as (mw, project):
                ...
                with closing(ProjectServer(project)) as project_server:
                    ...
                    def pw_task(raw_page: RawPage, *args, **kwargs) -> None:
                        ...
                        expect(screen_banner).to_contain_text('This page was archived using Crystal')
                    await pw.run(pw_task)
            ...
            async with (await OpenOrCreateDialog.wait_for()).create() as (mw, project):
                ...
                with closing(ProjectServer(project)) as project_server:
                    ...
                    def pw_task(raw_page: RawPage, *args, **kwargs) -> None:
                        ...
                        expect(pictures_banner).to_contain_text('This page was archived using Crystal')
                    await pw.run(pw_task)
    ...
    with mock_server:
        ...
        async with (await OpenOrCreateDialog.wait_for()).create() as (mw, project):
            ...
            with closing(ProjectServer(project)) as project_server:
                ...
                assert 'This page was archived using Crystal' in served_page_with_banner.content
            ...
            with patch.object(HtmlDocument, 'try_insert_footer_banner', return_value=False):
                with closing(ProjectServer(project)) as project_server:
                    ...
                    assert 'This page was archived using Crystal' not in served_page_without_banner.content
