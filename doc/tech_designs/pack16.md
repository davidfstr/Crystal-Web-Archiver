...
should be. Try to open the pack file. If pack file does not exist or the revision
is not found in it then try to open the revision's Hierarchical file instead.
If that also fails then report that the revision's body file is missing.
