...
from crystal.filesystem import FilesystemPath, LocalFilesystem
...
def test_pack_filepath_for_revision_id_computes_correct_values() -> None:
    ...
    with xtempfile.TemporaryDirectory() as project_path:
        ...
        assert RR._body_pack_filepath_with(FilesystemPath(LocalFilesystem(), project_path), 0x001) == expected
        assert RR._body_pack_filepath_with(FilesystemPath(LocalFilesystem(), project_path), 0x00f) == expected
        ...
        assert RR._body_pack_filepath_with(FilesystemPath(LocalFilesystem(), project_path), 0x010) == expected
        assert RR._body_pack_filepath_with(FilesystemPath(LocalFilesystem(), project_path), 0x01a) == expected
        assert RR._body_pack_filepath_with(FilesystemPath(LocalFilesystem(), project_path), 0x01f) == expected
        ...
        assert RR._body_pack_filepath_with(FilesystemPath(LocalFilesystem(), project_path), 0xff0) == expected
        assert RR._body_pack_filepath_with(FilesystemPath(LocalFilesystem(), project_path), 0xfff) == expected
        ...
        assert RR._body_pack_filepath_with(FilesystemPath(LocalFilesystem(), project_path), 0x123456789ab) == expected
