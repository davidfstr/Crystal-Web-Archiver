...
* Ensure you can run an end-to-end test. Try `crystal --test crystal.tests.test_cli.test_when_launched_with_version_argument_then_prints_version_and_exits` or `poetry run crystal --test ...`.
